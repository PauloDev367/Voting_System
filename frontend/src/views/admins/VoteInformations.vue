<template>
    ...
    <main>
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6">
                    ...
                    <button class="btn btn-sm btn-block btn-info" data-toggle="modal" data-target="#modalAddRepresent">
                ...
                <div class="col-12 col-md-6 text-center mt-4">
                    <div class="row">
                        ...
                        <div class="col-12 mt-3">
                            <ul>
                                <li>Total usuários no sistema: 12</li>
                                <li>Total usuários online: 12</li>
                                <li>Total usuários que votaram: 3</li>
                                <li>Total usuários que não votaram: 9</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal fade" id="modalAddRepresent" tabindex="-1" role="dialog"
            aria-labelledby="modalAddRepresentLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalAddRepresentLabel">Adicionar representante</h5>
